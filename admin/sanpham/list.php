          ...
          <form action="#" method="POST">
           ...
           <?php
            ...
            <tr >
                ...
                <a href="'.$hard_delete.'"> <input type="button" value="Xóa cứng" onclick="return confirm(\'bạn có muốn xóa cứng ko \')" ></a>
                <a href="'.$soft_delete.'"> <input type="button" value="Xóa mềm" onclick="return confirm(\'bạn có muốn xóa mềm ko \')" ></a>
            </tr>';
                }
                ?>
           </table>
